...
node ./Multiplier3/Multiplier3_js/generate_witness.js ./Multiplier3/Multiplier3_js/Multiplier3.wasm ./input_plonk.json ./Multiplier3/witness.wtns 


snarkjs groth16 setup ./Multiplier3/Multiplier3.r1cs ./powersOfTau28_hez_final_10.ptau ./Multiplier3/circuit_0000.zkey
snarkjs g16p Multiplier3/circuit_0000.zkey Multiplier3/witness.wtns Multiplier3/proof.json Multiplier3/public.json
