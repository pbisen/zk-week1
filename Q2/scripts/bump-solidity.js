...
const verifierRegex3 = /contract PlonkVerifier/
...
bumped = bumped.replace(verifierRegex2, 'contract Multiplier3Verifier');
...
bumped = content.replace(solidityRegex, 'pragma solidity ^0.8.0');
bumped = bumped.replace(verifierRegex3, 'contract Multiplier3_plonkVerifier');
