...
node ./HelloWorld/HelloWorld_js/generate_witness.js ./HelloWorld/HelloWorld_js/HelloWorld.wasm ./input_hello.json ./HelloWorld/witness.wtns 


snarkjs groth16 setup HelloWorld/HelloWorld.r1cs powersOfTau28_hez_final_10.ptau HelloWorld/circuit_0000.zkey
snarkjs g16p HelloWorld/circuit_0000.zkey HelloWorld/witness.wtns HelloWorld/proof.json HelloWorld/public.json
